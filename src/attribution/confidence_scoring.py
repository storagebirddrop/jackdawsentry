...
from .models import ConfidenceFactors
...
class ConfidenceScorer:
    ...
    async def _calculate_blockchain_confidence(
        self, attribution: AddressAttribution
    ) -> float:
        ...
        if attribution.evidence:
            ...
            blockchain_evidence = [
                ev
                for ev in attribution.evidence.values()
