...
async def create_victim_report(
    ...
    try:
        ...
        raise JackdawException(message="Failed to create victim report", details=str(e))
...
async def list_victim_reports(
    ...
    try:
        ...
        raise JackdawException(message="Failed to list victim reports", details=str(e))
...
async def get_victim_report(
    ...
    try:
        ...
        raise JackdawException(message="Failed to get victim report", details=str(e))
...
async def update_victim_report(
    ...
    try:
        ...
        raise JackdawException(message="Failed to update victim report", details=str(e))
...
async def delete_victim_report(
    ...
    try:
        ...
        raise JackdawException(message="Failed to delete victim report", details=str(e))
...
async def verify_victim_report(
    ...
    try:
        ...
        updated_report = await victim_reports_db.update_report(
            report_id, verification_data
        )
        ...
        raise JackdawException(message="Failed to verify victim report", details=str(e))
...
async def get_report_statistics(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get victim report statistics", details=str(e)
        )
...
async def search_reports_by_address(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to search victim reports by address", details=str(e)
        )
...
async def search_reports_by_transaction(
    ...
    try:
        ...
        logger.error(
            f"Failed to search victim reports by transaction {transaction_hash}: {e}"
        )
        raise JackdawException(
            message="Failed to search victim reports by transaction", details=str(e)
        )
