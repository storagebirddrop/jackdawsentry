...
async def add_member(
    ...
    from src.services.teams import add_member as _add, get_organization as _get
    async with get_postgres_connection() as conn:
...
async def list_members(
    ...
    from src.services.teams import list_members as _list, get_organization as _get
    async with get_postgres_connection() as conn:
        if not await _get(conn, org_id):
            raise HTTPException(status_code=404, detail="Organization not found")
...
async def remove_member(
    ...
    from src.services.teams import remove_member as _remove, get_organization as _get
    async with get_postgres_connection() as conn:
        if not await _get(conn, org_id):
            raise HTTPException(status_code=404, detail="Organization not found")
