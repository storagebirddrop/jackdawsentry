...
async def list_professional_services(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to list professional services", details=str(e)
        )
...
async def create_professional_service(
    ...
    try:
        ...
        logger.info(
            f"Created professional service request {created_service.id} by user {current_user.id}"
        )
        ...
        raise JackdawException(
            message="Failed to create professional service", details=str(e)
        )
...
async def get_professional_service(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get professional service", details=str(e)
        )
...
async def update_professional_service(
    ...
    try:
        ...
        logger.info(
            f"Updated professional service {service_id} by user {current_user.id}"
        )
        ...
        raise JackdawException(
            message="Failed to update professional service", details=str(e)
        )


@router.get("/professionals", response_model=List[ProfessionalProfileResponse])
async def list_professionals(
    expertise_level: Optional[str] = Query(
        None, description="Filter by expertise level"
    ),
    ...
    try:
        ...
        raise JackdawException(message="Failed to list professionals", details=str(e))
...
async def create_professional_profile(
    ...
    try:
        ...
        logger.info(
            f"Created professional profile {created_profile.id} by user {current_user.id}"
        )
        ...
        raise JackdawException(
            message="Failed to create professional profile", details=str(e)
        )


@router.get(
    "/professionals/{professional_id}", response_model=ProfessionalProfileResponse
)
async def get_professional_profile(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get professional profile", details=str(e)
        )
...
async def list_training_programs(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to list training programs", details=str(e)
        )
...
async def create_training_program(
    ...
    try:
        ...
        logger.info(
            f"Created training program {created_program.id} by user {current_user.id}"
        )
        ...
        raise JackdawException(
            message="Failed to create training program", details=str(e)
        )
...
async def enroll_in_training(
    ...
    try:
        ...
        logger.info(
            f"Enrolled user {current_user.id} in training program {enrollment.training_program_id}"
        )
        ...
        raise JackdawException(message="Failed to enroll in training", details=str(e))
...
async def get_service_statistics(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get service statistics", details=str(e)
        )


@router.post(
    "/services/{service_id}/assign", response_model=ProfessionalServiceResponse
)
async def assign_professional(
    ...
    try:
        ...
        logger.info(
            f"Assigned professional {professional_id} to service {service_id} by user {current_user.id}"
        )
        return ProfessionalServiceResponse(**updated_service.__dict__)
        ...
        raise JackdawException(message="Failed to assign professional", details=str(e))
...
async def get_my_services(
    ...
    try:
        ...
        raise JackdawException(message="Failed to get user services", details=str(e))
