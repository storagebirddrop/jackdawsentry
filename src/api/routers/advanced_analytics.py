...
from src.analytics import (
    ...
    PathfindingRequest, PathfindingResponse, PathfindingResult,
    SeedAnalysisRequest, SeedAnalysisResponse, SeedAnalysisResult,
    FingerprintingRequest, FingerprintingResponse, FingerprintResult,
    BatchAnalyticsRequest, BatchAnalyticsResponse,
    PathfindingAlgorithm, DerivationType, FingerprintType
)
...
async def fingerprint_transactions(
    ...
    try:
        ...
        result = await analytics_engine.fingerprinter.fingerprint_transactions(fingerprint_request)
...
async def list_fingerprint_patterns(
    pattern_type: Optional[FingerprintType] = Query(None, description="Filter by pattern type"),
    current_user: User = Depends(get_current_user)
):
    """
...
async def analytics_health_check():
    ...
    try:
        ...
        components = {
            "pathfinder": analytics_engine.pathfinder._initialized if hasattr(analytics_engine.pathfinder, '_initialized') else False,
            "seed_analyzer": analytics_engine.seed_analyzer._initialized if hasattr(analytics_engine.seed_analyzer, '_initialized') else False,
            "fingerprinter": analytics_engine.fingerprinter._initialized if hasattr(analytics_engine.fingerprinter, '_initialized') else False
        }
