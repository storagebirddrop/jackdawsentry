...
VALID_FEED_TYPES = {"sanctions", "scam", "hack", "phishing", "malware", "ransomware", "terrorism", "money_laundering", "dark_web", "mixer", "exchange_hack", "defi_exploit", "nft_fraud", "social_engineering"}
...
async def list_threat_feeds(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to list threat feeds",
            details=str(e)
        )

@router.post("/", response_model=ThreatFeedResponse, status_code=status.HTTP_201_CREATED)
...
async def get_threat_feed(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get threat feed",
            details=str(e)
        )
...
async def sync_threat_feed(
    ...
    try:
        ...
        logger.info(f"Triggered manual sync for threat feed {feed_id} by user {current_user.id}")
        ...
        raise JackdawException(
            message="Failed to sync threat feed",
            details=str(e)
        )
...
async def get_feed_health(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get feed health",
            details=str(e)
        )
...
async def query_threat_intelligence(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to query threat intelligence",
            details=str(e)
        )
...
async def get_feed_statistics(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get threat feed statistics",
            details=str(e)
        )
...
async def sync_all_feeds(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to sync all feeds",
            details=str(e)
        )
...
async def get_recent_intelligence(
    ...
    try:
        ...
        raise JackdawException(
            message="Failed to get recent intelligence",
            details=str(e)
        )
